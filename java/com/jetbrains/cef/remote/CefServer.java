    ...
    public boolean start(CefAppHandler appHandler) {
        try {
            ...
            if (runningRoot != null) {
                ...
                final boolean success = ServerStarter.startProcessAndWait(myThriftServer, appHandler, myParams.args, myParams.settings, false, WAIT_FOR_SERVER_START_SEC*1000l);
                if (!success)
                    return false;
            }
