 ...
 */
public abstract class CefMessageRouterBase extends CefNativeAdapter implements CefMessageRouter {
     ...
     * to add a handler.
     */
    public static final CefMessageRouterBase create() {
        return CefMessageRouterBase.create(null, null);
    }
     ...
     */
    public static final CefMessageRouterBase create(CefMessageRouterConfig config) {
        return CefMessageRouterBase.create(config, null);
    }

    /**
     * Create a new router with the specified handler and default configuration.
     */
    public static final CefMessageRouterBase create(CefMessageRouterHandler handler) {
        return CefMessageRouterBase.create(null, handler);
    }
