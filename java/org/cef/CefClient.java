...
public interface CefClient extends Disposable {
    ...
    @Deprecated
    CefBrowser createBrowser(String url, boolean isOffscreenRendered, boolean isTransparent);
    @Deprecated
    CefBrowser createBrowser(String url, boolean isOffscreenRendered, boolean isTransparent, CefRequestContext context);

    CefBrowser createBrowser(String url, CefRendering rendering, boolean isTransparent);
    CefBrowser createBrowser(String url, CefRendering rendering, boolean isTransparent, CefRequestContext context);
}
