...
public class CefClientImpl extends CefClientHandler
        implements CefClient, CefContextMenuHandler, CefDialogHandler, CefDisplayHandler, CefDownloadHandler,
     ...
     */
    CefClientImpl() throws UnsatisfiedLinkError {
        super();
